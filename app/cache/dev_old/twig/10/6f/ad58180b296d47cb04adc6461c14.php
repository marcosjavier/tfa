...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "    <div id=\"layout\">
        <div id=\"encabezado\">
            <h1>Formulario de Inscripcion a Pasantías no Rentadas</h1>
            
        </div>
            <div id=\"contenido\">
                <form action=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("UsuarioInscripcionBundle_homepage"), "html", null, true);
        echo "\" method=\"post\">
                 ";
        // line 13
